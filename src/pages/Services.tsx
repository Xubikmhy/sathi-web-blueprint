        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            {services.map((service, index) => (
              <Card 
                key={index} 
                className="bg-white/10 backdrop-blur-sm border-white/20 hover:bg-white/20 transition-all duration-300 hover-scale group shadow-lg"
              >
                <CardContent className="p-10">
                  <div className="flex items-start space-x-6">
                    <div className="w-16 h-16 bg-brand-green rounded-full flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mb-6">
                        <h4 className="text-brand-green font-semibold mb-3">Key Features:</h4>
                      ...
                      <Button 
                        asChild
                        className="bg-brand-green text-black hover:bg-brand-green/90 font-semibold group hover-scale shadow-lg"
                      >
